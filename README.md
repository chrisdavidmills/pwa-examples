...
- [Install demos](install-demos): A series of examples that demonstrate creating in-app PWA install buttons using the `<install>` element and the `Navigator.install()` method.
